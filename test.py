...
score_surface = game_font.render("Running Man", False, (64,64,64)) #render takes three arguments: the text to display, whether you want anti-aliasing, and the color of the font
